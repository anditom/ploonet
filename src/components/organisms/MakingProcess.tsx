...
const MakingProcess: React.FC = () => {
  ...
  return (
    <section className="text-white py-16 text-center">
      ...
      <div className="flex flex-col md:flex-row justify-center md:space-x-10 w-full max-w-6xl mx-auto">
        {/* Card 1 */}
        <div
          ...
          style={{ backgroundColor: "#141414", margin: 10 }}
        >
          <div className="flex flex-col items-center justify-center mb-4">
            ...
            <ul className="space-y-4">
              {stepsGeneral.map((step, index) => (
                <li key={index} className="flex items-start space-x-1 p-1">
                  <div
                  ...
                  >
                    <span
                      className="absolute top-2 left-2 font-bold text-sm"
                      style={{
                        background:
                    ...
                    <span className="text-white font-bold text-sm mt-6">
                      {step.title}
                    </span>
        ...
        >
          <div className="flex flex-col items-center justify-center mb-4">
            ...
            <ul className="space-y-4" style={{ margin: 30 }}>
              {stepsQuickserve.map((step, index) => (
                <li key={index} className="flex items-center space-x-4 p-4">
                  ...
                  <div>
                    ...
                    <span className="block">{step.p1}</span>
                    <span className="block">{step.p2}</span>
                    <hr
                      style={{
                        border: "none",
      ...
      <p className="text-gray-400 max-w-3xl mx-auto mb-8 px-4">
